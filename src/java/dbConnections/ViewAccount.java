...
public class ViewAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewAccount</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewAccount at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(acc_number>0)
        {
            try
            {
                ...
                ResultSet rs=st.executeQuery("select * from UserDetails where acc_number="+acc_number); 
...
"</style>\n");
                    out.println("</head>\n" +
"\n" +
"<body id=\"accountViewPage\" data-spy=\"scroll\" data-target=\".navbar\" data-offset=\"60\">\n" +
"\n" +
...
"</nav>\n");
                  ...
                  //out.println("<div class='jumbotron'>");
                    out.println("<div class='jumbotron'>");
                    out.println("<h2>Your account details:<br/></h2>");
                    ...
                    out.println("<tr><th>Date of birth</th>");
                    out.println("<td>"+rs.getString(8)+"</td></tr>");
                    out.println("<tr><th>Current amount (Rupees)</th>");
